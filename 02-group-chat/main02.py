...
llm_config = {
    "cache_seed": 43,  # change the cache_seed for different trials; 41 is default, or NONE
...
user_proxy = autogen.UserProxyAgent(
    ...
    human_input_mode="TERMINATE", # only intervene at end
)
...
group_chat = autogen.GroupChat( # array of agent in group chat
    agents=[user_proxy, engineer, scientist, planner, critic], messages=[], max_round=12 # to avoid looping
)
